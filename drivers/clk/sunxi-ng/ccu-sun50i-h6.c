 ...
 */
static struct ccu_nm pll_audio_h616_hs_clk = {
	.enable		= BIT(31),
	.lock		= BIT(28),
	.n		= _SUNXI_CCU_MULT_MIN(8, 8, 12),
	.m		= _SUNXI_CCU_DIV(1, 1), /* input divider */
...
static const char * const audio_h616_parents[] = { "pll-audio-1x", "pll-audio-2x", "pll-audio-4x", "pll-audio-hs" };
...
static struct ccu_div spdif_h616_clk = {
	.enable		= BIT(31),
	.div		= _SUNXI_CCU_DIV_FLAGS(8, 2, CLK_DIVIDER_POWER_OF_TWO),
	.mux		= _SUNXI_CCU_MUX(24, 2),
	.common		= {
...
static struct ccu_div dmic_h616_clk = {
	.enable		= BIT(31),
	.div		= _SUNXI_CCU_DIV_FLAGS(8, 2, CLK_DIVIDER_POWER_OF_TWO),
	.mux		= _SUNXI_CCU_MUX(24, 2),
	.common		= {
...
static struct ccu_div audio_hub_h616_clk = {
	.enable		= BIT(31),
	.div		= _SUNXI_CCU_DIV_FLAGS(8, 2, CLK_DIVIDER_POWER_OF_TWO),
	.mux		= _SUNXI_CCU_MUX(24, 2),
	.common		= {
...
static const struct clk_hw *clk_parent_h616_pll_audio[] = {
	&pll_audio_h616_hs_clk.common.hw
};
...
static CLK_FIXED_FACTOR_HWS(pll_audio_1x_h616_clk, "pll-audio-1x",
			    clk_parent_h616_pll_audio,
			    96, 1, CLK_SET_RATE_PARENT);
static CLK_FIXED_FACTOR_HWS(pll_audio_2x_h616_clk, "pll-audio-2x",
			    clk_parent_h616_pll_audio,
			    48, 1, CLK_SET_RATE_PARENT);
static CLK_FIXED_FACTOR_HWS(pll_audio_4x_h616_clk, "pll-audio-4x",
			    clk_parent_h616_pll_audio,
			    24, 1, CLK_SET_RATE_PARENT);
...
static struct ccu_common *sun50i_h616_ccu_clks[] = {
	...
	&bus_ts_clk.common,
	&bus_ths_clk.common,
	&spdif_h616_clk.common,
	&bus_spdif_clk.common,
	&dmic_h616_clk.common,
	&bus_dmic_clk.common,
	&audio_codec_1x_clk.common,
	&audio_codec_4x_clk.common,
	&bus_audio_codec_clk.common,
	&audio_hub_h616_clk.common,
	&bus_audio_hub_clk.common,
	&usb_ohci0_clk.common,
	&usb_phy0_clk.common,
...
static struct clk_hw_onecell_data sun50i_h616_hw_clks = {
	.hws	= {
		...
		[CLK_PLL_VE]		= &pll_ve_clk.common.hw,
		[CLK_PLL_DE]		= &pll_de_clk.common.hw,
		[CLK_PLL_AUDIO_BASE]	= &pll_audio_h616_hs_clk.common.hw,
		[CLK_PLL_AUDIO]		= &pll_audio_1x_h616_clk.hw,
		[CLK_PLL_AUDIO_2X]	= &pll_audio_2x_h616_clk.hw,
		[CLK_PLL_AUDIO_4X]	= &pll_audio_4x_h616_clk.hw,
		...
		[CLK_BUS_TS]		= &bus_ts_clk.common.hw,
		[CLK_BUS_THS]		= &bus_ths_clk.common.hw,
		[CLK_SPDIF]		= &spdif_h616_clk.common.hw,
		[CLK_BUS_SPDIF]		= &bus_spdif_clk.common.hw,
		[CLK_DMIC]		= &dmic_h616_clk.common.hw,
		[CLK_BUS_DMIC]		= &bus_dmic_clk.common.hw,
		...
		[CLK_AUDIO_HUB]		= &audio_hub_h616_clk.common.hw,
		[CLK_BUS_AUDIO_HUB]	= &bus_audio_hub_clk.common.hw,
		[CLK_USB_OHCI0]		= &usb_ohci0_clk.common.hw,
		[CLK_USB_PHY0]		= &usb_phy0_clk.common.hw,
